...
class Merriages extends StatelessWidget {
  const Merriages({super.key});
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            const Text(
              'Welcome to Our Marriages Donation!',
              style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
              textAlign: TextAlign.center,
            ),
            const SizedBox(height: 20),
            Image.asset(
              'images/merriage.png', // Replace with your restaurant logo image
              height: 150,
              width: 150,
            ),
            const SizedBox(height: 20),
